...
from inference.sliding_window import sliding_window
...
def main():
    ...
    train_loader = DataLoader(
        ForgeryDataset(train_ids, config.target_size),
    ...
    val_loader = DataLoader(
        ForgeryDataset(val_ids, config.target_size),
        batch_size=config.batch_size,
        shuffle=False,
    ...
    for epoch in range(config.num_epochs):
        ...
        val_f1 = validate_one_epoch(
            ...
            device=device,
            sliding_window_fn=sliding_window,
